...
export interface ReportMaintenanceScreenProps {
...
const ReportMaintenance = ({ navigation }: ReportMaintenanceScreenProps) => {
    ...
    const getData = async () => {
        let dataResponse = await CommonBase.postAsync<ResponseService>("/api/maintenance-management-service/maintenances-repair/get-paging-maintenances-repair", DataInput);
            ...
            >
                ...
                <View style={[styles.gird]}>
                    <View style={[styles.label]}>
                        ...
                        <Text style={[styles.text]}> Bảo dưỡng nhỏ</Text>
                    </View>
                    <View style={[styles.label]}>
                        <Text style={[styles.box2]}></Text>
                        <Text style={[styles.text]}> Bảo dưỡng lớn</Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>
